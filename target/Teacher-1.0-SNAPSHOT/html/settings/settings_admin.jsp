    ...
    <script>
        $(document).ready(function() {
            $("#modify").click(function() {
                ...
                $.ajax({
                    type: "POST",
                    url: "ModifyAdminMes", // 替换为您的Servlet URL
                    data: { "email": email },
                    // dataType:"json",
        ...
        $(document).ready(function() {
            $("#ok").click(function() {
                ...
                console.log(oldpwd);
                console.log(newpwd_1);
                console.log(newpwd_2);
                $.ajax({
                    type: "POST",
                    url: "ModifyAdminPwd", // 替换为您的Servlet URL
                    data: {
                        "oldpwd":oldpwd,
                        "newpwd_1":newpwd_1,
                        "newpwd_2":newpwd_2
        ...
        $(document).ready(function() {
            $("#cmt").click(function() {
                ...
                $.ajax({
                    type: "POST",
                    url: "InsertAdminCmt", // 替换为您的Servlet URL
                    data: {
                        "comment":comment
                    },
                    // dataType:"json",
    ...
    <div class="column2 clearfix">
        <div class="column2-1">
            ...
            <form class="modifyMes">
                ...
                %>
                姓名：<input type="text" readonly name="name" value="admin"%><br><br>
                工号：<input type="text" readonly name="id" value=<%=admin.getUsername()%>><br><br>
                邮箱：<input type="text" name="email" value=<%=admin.getEmail()%>><br><br>
