    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $("#SearchMeeting").click(function () {
                $("#SearchMeeting").css("color", "red");
                var keyword = $("input[name='keyword']").val();
                $.ajax({
                    type: "GET",
                    url: "SearchMeeting", // 替换为您的Servlet URL
...
<div class="container">
    <div class="public-nav">您当前的位置：<a href="">工作管理</a>><a href="">班会开展</a></div>
    <div class="public-content">
        <div class="public-content-header">
            <h3>修改信息</h3>
            <div class="search">
                <form action="../../SearchMeeting" method="get">
                    <input type="hidden" name="method" value="SearchMeeting" />
                    <input placeholder="请输入..." name="keyword" type="text" value="">
                    <button type="button" id="SearchMeeting"></button>
                </form>
            </div>
        ...
        <div class="public-content-cont">
            <table class="public-cont-table">
                ...
                <%
                    ArrayList MeetingAL=(ArrayList)session.getAttribute("MeetingAL");
                    Iterator iter=MeetingAL.iterator();
                    while(iter.hasNext()){
                        Meetings meeting=(Meetings) iter.next();
                %>
                <tr><td><%= meeting.getDate() %></td>
                    <td><%= meeting.getTheme() %></td>
                    <td><%= meeting.getContent() %></td>
                    <td>
                        <div class="table-fun">
                            <a class="btn btn-primary btn-large modify" href="javascript:;"
                               data-date="<%= meeting.getDate() %>"
                               data-theme="<%= meeting.getTheme() %>"
                               data-content="<%= meeting.getContent() %>">
                                修改
                            </a>
                        </div>
                    </td>
    ...
    <div class="theme-popbod dform">
        <form class="theme-signin" name="modifyform">
            <ol>
                ...
                <li><strong>主题：</strong><input class="ipt" type="text" name="theme" size="20" /></li>
                <li><strong>内容：</strong><input class="ipt" type="text" name="content" size="20" /></li>
                <li><input class="btn btn-primary" type="button" name="submit" value=" 提交修改 " /></li>
    ...
    <div class="theme-popbod dform">
        <form class="theme-add" name="addform">
            <ol>
                ...
                <li><strong>主题：</strong><input class="ipt" type="text" name="add_theme" size="20" /></li>
                <li><strong>内容：</strong><input class="ipt" type="text" name="add_content" size="20" /></li>
                <li><input class="btn btn-primary" type="button" name="submit" value=" 添加 " /></li>
